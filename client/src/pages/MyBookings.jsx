...
const MyBookings = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      <Title title={`My Bookings`} subTitle={`add something`} align={`left`} />

      <div>
        {
          bookings.map((booking,index) => (
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt05 first:mt-12' key={booking._id}>
              <div className='md:col-span-1'>
                <div className='rounded-md overflow-hidden mb-3'>
                  <img src={booking.car.image} className='w-full h-auto aspect-video object-cover' alt="car" />
                </div>
